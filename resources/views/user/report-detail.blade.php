...
<head>
    ...
    <title>Hinweis #{{ $report->id }} - Hinweisgeberportal</title>
            ...
            <div class="card">
                ...
                <div class="card-body" style="padding: 1rem;">
                    ...
                    <div id="chatClosedNotice" style="display:none; background:#fef2f2; border:1px solid #fca5a5; border-radius:4px; padding:10px 14px; margin-top:10px; color:#991b1b; font-size:13px;">
                        &#9888; Dieser Hinweis ist abgeschlossen. Nachrichten können nicht mehr gesendet werden.
                    </div>
    ...
    <script>
        ...
        function initChatUI() {
            if (reportStatus === 'abgeschlossen') {
                ...
                if (input) { input.disabled = true; input.style.opacity = '0.5'; input.placeholder = 'Hinweis abgeschlossen – keine neuen Nachrichten möglich'; }
